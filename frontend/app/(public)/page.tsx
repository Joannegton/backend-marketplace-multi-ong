...
export default function Home() {
    ...
    const { products, isLoadingMore, hasMore, setCategories } =
        useProductStore();
                ...
                <div className="px-4 md:px-8 max-w-4xl mx-auto">
                    <div className="max-w-4xl mx-auto text-center space-y-6">
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-balance">
                            Marketplace{' '}
                            <span className="text-primary">Solidário</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto text-balance">
                            Conectando você com produtos incríveis de ONGs
                            parceiras em todo o Brasil. Cada compra faz a
                            diferença!
                        </p>
                    </div>
                </div>
            ...
            <section className="py-8 bg-primary text-primary-foreground">
                <div className="px-4 md:px-8 text-center space-y-6">
                    ...
                    <p className="text-xl max-w-2xl mx-auto opacity-90">
                        Cada compra no nosso marketplace ajuda ONGs a
                        continuarem seu trabalho transformador. Junte-se a nós
                        nessa jornada de solidariedade!
                    </p>
                    <Button
                        size="lg"
                        variant="secondary"
