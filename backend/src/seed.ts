...
async function seed() {
    ...
    `,
      ...
      VALUES
        ...
        (gen_random_uuid(), '11111111-1111-1111-1111-111111111111', 'Mochila Escolar', 'Mochila resistente para estudantes', 79.90, 0.8, 30, 'Vestuário', 'https://example.com/backpack.jpg', true, NOW(), NOW()),
        ...
        (gen_random_uuid(), '11111111-1111-1111-1111-111111111111', 'Camiseta Educativa', 'Camiseta com mensagens motivacionais para estudantes', 35.00, 0.2, 40, 'Vestuário', 'https://example.com/edu-shirt.jpg', true, NOW(), NOW())
    ...
    `);
      ...
      VALUES
        ...
        (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Mel Orgânico', 'Mel puro extraído de colmeias locais', 25.00, 0.5, 80, 'Alimentos', 'https://example.com/honey.jpg', true, NOW(), NOW()),
        (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Cesta de Frutas', 'Cesta com frutas frescas da estação', 35.90, 2.0, 25, 'Alimentos', 'https://example.com/fruit-basket.jpg', true, NOW(), NOW()),
        ...
        (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Pão Caseiro', 'Pão integral assado diariamente', 8.50, 0.4, 150, 'Alimentos', 'https://example.com/bread.jpg', true, NOW(), NOW()),
        (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Bolsa de Tecido', 'Bolsa feita de tecido reciclado', 42.00, 0.2, 35, 'Vestuário', 'https://example.com/bag.jpg', true, NOW(), NOW()),
        (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Queijo Artesanal', 'Queijo maturado por 6 meses', 55.00, 0.8, 40, 'Alimentos', 'https://example.com/cheese.jpg', true, NOW(), NOW()),
        (gen_random_uuid(), '22222222-2222-2222-2222-222222222222', 'Cachecol de Lã', 'Cachecol tricotado à mão com lã natural', 65.00, 0.3, 20, 'Vestuário', 'https://example.com/scarf.jpg', true, NOW(), NOW())
      ON CONFLICT DO NOTHING;
    `);
      ...
      VALUES 
        ...
        (gen_random_uuid(), '33333333-3333-3333-3333-333333333333', 'Doce de Leite Artesanal', 'Doce de leite caseiro feito com leite fresco', 28.50, 0.4, 60, 'Alimentos', 'https://example.com/dulce-de-leche.jpg', true, NOW(), NOW()),
    ...
    `);
        ...
        console.log(
            '   ONG Vida: 22222222-2222-2222-2222-222222222222 (8 produtos: Artesanato, Alimentos, Vestuário)',
        );
        console.log(
